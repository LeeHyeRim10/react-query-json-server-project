...
const Dashboard = () => {
  ...
  return (
    ...
    >
      ...
      >
        {[
          ['총 매출액', `${kpi.totalSalesAmount.toLocaleString()}원`],
          ['총 판매수량', `${kpi.totalQuantity.toLocaleString()}개`],
          ['총 주문건수', `${kpi.totalOrderCount.toLocaleString()}건`],
          ['고객 수', `${kpi.customerCount.toLocaleString()}명`],
          ['상품 수', `${kpi.productCount.toLocaleString()}개`],
        ].map(([title, value]) => (
          <div
            key={title}
            style={{
